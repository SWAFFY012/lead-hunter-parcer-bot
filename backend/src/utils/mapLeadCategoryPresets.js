...
export const MAP_LEAD_CATEGORY_PRESETS = {
  detailing: {
    ...
    includeKeywords: [
      ...
      'бронирование кузова', 'химчистка авто', 'автомоечный', 'мойка машин',
      'тонирование', 'тонировка', 'уход за автомобилем', 'автостудия',
    ],
    ...
    excludeKeywords: [
      ...
      'прачечная', 'ковров', 'ковровых', 'ковровые', 'барбершоп',
      'парикмахерская', 'парикмахер', 'клининг',
      'ресторан', 'кафе', 'салон красоты', 'тату',
      // Русские рубрики приходят при hl=ru: «Кальянная», «Уборка»,
      // «Оптовая продажа ковровых покрытий».
      'кальянная', 'кальян', 'уборка', 'ковровых', 'ковёр', 'ковер',
      'бар', 'паб', 'пиццерия', 'столовая', 'отель', 'гостиница',
      'магазин', 'аптека', 'недвижимость', 'недвижимости', 'пирсинг', 'маникюр',
      'стоматолог', 'фитнес', 'спортзал', 'химчистка одежды',
    ],
  },
};
